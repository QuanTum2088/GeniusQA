...
class TaskSchedulerService:
    ...
    async def _sync_task_notification_setting(
        ...
        *,
        ...
        from app.api.v1.Ntesterc_module.Ntesterc_notifications.service import task_notification_service
        from app.api.v1.Ntesterc_module.Ntesterc_notifications.schema import TaskNotificationSettingCreate, TaskNotificationSettingUpdate
    ...
    async def execute_scheduled_task(task_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if int(task_config.get("type") or 0) == 3:
                ...
                from app.api.v1.Ntesterc_module.Ntesterc_api.model import ApiScriptModel
            ...
            # type==2-->WebManagementService.execute_web_script()
                ...
                from app.infra.db.sqlalchemy import async_session
                from app.api.v1.Ntesterc_module.Ntesterc_web.service import WebManagementService
                from app.api.v1.Ntesterc_module.Ntesterc_web.model import WebGroupModel
    ...
    async def send_task_notification(task_result: Dict[str, Any], notice_config: Dict[str, Any]) -> bool:
        ...
        """
        from app.infra.db.sqlalchemy import async_session
        from app.api.v1.Ntesterc_module.Ntesterc_notifications.service import notification_service, task_notification_service
        from app.api.v1.Ntesterc_module.Ntesterc_notifications.schema import SendNotificationRequest
        ...
        async with async_session() as session:
            ...
            if task_type == "API":
                ...
                if api_result_id:
                    ...
                    try:
                        from app.api.v1.Ntesterc_module.Ntesterc_api.model import ApiScriptResultListModel
                ...
                if web_result_id:
                    ...
                    try:
                        from app.api.v1.Ntesterc_module.Ntesterc_web.model import WebResultListModel
