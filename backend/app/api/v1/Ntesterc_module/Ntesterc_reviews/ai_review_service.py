...
from app.api.v1.Ntesterc_module.Ntesterc_intel.model import AIModelConfigModel, PromptConfigModel
from app.api.v1.Ntesterc_module.Ntesterc_intel.service import AIModelService
