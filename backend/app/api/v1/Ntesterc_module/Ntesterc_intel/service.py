...
class RequirementDocumentService:
    ...
    async def analyze_document(
        ...
        Returns:
            分析结果字典
        """
        from app.api.v1.Ntesterc_module.Ntesterc_intel.requirement_analysis_service import RequirementAnalysisService
...
class AICaseService:
    ...
    async def execute_ai_case(
        ...
        Returns:
            执行结果字典
        """
        from app.api.v1.Ntesterc_module.Ntesterc_intel.browser_use_service import BrowserUseService
