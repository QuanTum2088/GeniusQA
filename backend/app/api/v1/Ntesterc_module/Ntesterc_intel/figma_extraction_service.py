...
class FigmaExtractionService:
    ...
    async def create_extraction_task(
        ...
        Returns:
            task_id: 任务ID
        """
        from app.api.v1.Ntesterc_module.Ntesterc_intel.model import FigmaExtractionTaskModel
    ...
    async def update_task_progress(
        ...
        """更新任务进度"""
        from app.api.v1.Ntesterc_module.Ntesterc_intel.crud import FigmaExtractionTaskCRUD
