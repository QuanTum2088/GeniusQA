  ...
  <div class="login-container" :style="containerStyle">
      ...
      <div class="login-left">
        <div class="brand-section">
          ...
          <div class="brand-description">
            专业的自动化AI驱动GeniusQA平台，提供API测试、UI测试、APP测试，AI用例生成，等全方位解决方案
          </div>
        </div>
    ...
    <div class="login-copyright">
      <div class="copyright-content">
        <span>© 2026-2027 GeniusQA平台. rebort版本所有 贵ICP备2026069493号-1.</span>
...
const logoText = computed(() => {
  return store.state.themeConfig?.themeConfig?.logoText || platformName.value || 'GeniusQA平台'
})
